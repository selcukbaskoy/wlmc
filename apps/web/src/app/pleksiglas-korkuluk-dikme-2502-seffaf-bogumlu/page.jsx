...
export default function PleksiDikme2502SeffafBogumluPage() {
  ...
  useEffect(() => {
    document.title =
      "Pleksiglas Korkuluk Dikme 2502 Şeffaf Boğumlu Model | Walmco";
    ...
    metaDescription.content =
      "2502 Şeffaf Boğumlu model pleksiglas korkuluk dikme. Boğumlu tasarım, şeffaf yapı, eloksal aksesuar. Hızlı kargo, garanti.";
  ...
  const productImages = [
    {
      url: "https://ucarecdn.com/56a2865f-817c-4f8f-9540-fa55182a58c9/-/format/auto/",
  ...
  const handleQuoteRequest = () => {
    const productInfo = {
      name: "Pleksiglas Korkuluk Dikme – 2502 Şeffaf Boğumlu Model",
      category: "Pleksi Korkuluk Dikmeleri",
      description: "Boğumlu tasarım, şeffaf yapı, eloksal aksesuar. Hızlı kargo, garanti.",
      image: "https://ucarecdn.com/56a2865f-817c-4f8f-9540-fa55182a58c9/-/format/auto/",
  ...
  const handleWhatsAppClick = () => {
    const productName = "Pleksiglas Korkuluk Dikme – 2502 Şeffaf Boğumlu Model";
        ...
        <div className="relative w-full max-w-4xl">
          ...
          <div className="relative">
            <img
                  ...
                  productName="2502 bogumlu Model"
        ...
        return (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                {
                  title: "Şeffaf Boğumlu Tasarım",
                  description:
                    "Şeffaf yapı ve boğumlu tasarım ile modern estetik görünüm",
                  icon: Star,
                },
                {
                  title: "Sağlam & Hafif",
                ...
                },
                {
                  ...
                  description:
                    "Eloksal renk ve RAL boya, şeffaf boğumlu varyasyonları",
                  icon: Grid3X3,
                },
                {
                  title: "Kolay Bakım",
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                "Modern merdiven korkulukları",
                "Şeffaf balkon küpeşteleri",
                "Ofis ve işyeri ayırıcıları",
                "Vitrin & showroom tasarımları",
                "Minimal tasarım projeleri",
              ].map((area, index) => (
                <div
                  key={index}
        ...
        return (
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-4">
              {[
                "1 adet Pleksiglas Korkuluk Dikme (2502 Şeffaf Boğumlu Model)",
      ...
      case "faq":
        return (
          <div className="space-y-4">
            {[
              {
                q: "Boğumlu tasarım ne anlama geliyor?",
                a: "Boğumlu tasarım, ürün üzerindeki eklemli yapıyı ifade eder. Bu tasarım hem estetik hem de yapısal dayanıklılık sağlar.",
              },
              {
                q: "Şeffaflık oranı nedir?",
                a: "Ürün %92 oranında şeffaflık sunar, doğal ışığın maksimum geçişini sağlar.",
              },
              {
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-8">
                  Şeffaf boğumlu tasarım ile modern estetik sunan pleksiglas
                  korkuluk dikmesi. Doğal ışık geçirgenliği ve dayanıklılığı bir
                  arada.
                </p>
              </div>
