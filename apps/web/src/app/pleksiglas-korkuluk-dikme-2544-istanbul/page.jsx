...
export default function PleksiDikme2544IstanbulPage() {
  const [selectedBodyType, setSelectedBodyType] = useState("kabarcikli");
  const [selectedFinish, setSelectedFinish] = useState("altin");
  ...
  useEffect(() => {
    document.title = "Pleksiglas Korkuluk Dikme 2544 İstanbul Model | Walmco";
    ...
    metaDescription.content =
      "2544 İstanbul model pleksiglas korkuluk dikme. Altın renkli aksesuar, dekoratif desenler, lüks görünüm, premium finish. Hızlı kargo, garanti.";
  ...
  const productImages = [
    {
      url: "https://ucarecdn.com/cee60a70-fc54-4931-98a4-db90d55287e6/-/format/auto/",
      alt: "Pleksiglas korkuluk dikme 2544 İstanbul model",
      title: "Ana Görünüm",
    },
  ];
  ...
  const finishOptions = [
    {
      id: "altin",
      label: "Altın Aksesuar",
      description: "Premium altın renkli yüzey",
    },
    { id: "eloksal", label: "Eloksal Renk", description: "Standart eloksal kaplama" },
    { id: "ral", label: "RAL Kodu", description: "Özel renk seçenekleri" },
  ];

  const handleQuoteRequest = () => {
    const productName = "Pleksiglas Korkuluk Dikme – 2544 İstanbul Model";
    const productDetails = `Gövde Tipi: ${selectedBodyType === "kabarcikli" ? "Kabarcıklı" : "Kabarcıksız"}, Aksesuar: ${selectedFinish === "altin" ? "Altın Aksesuar" : selectedFinish === "eloksal" ? "Eloksal Renk" : "RAL Kodu"}, Adet: ${quantity}`;
        ...
        <div className="relative w-full max-w-4xl">
          ...
          <div className="relative">
            <img
                  ...
                  productName="2544 istanbul Model"
        ...
        return (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                {
                  title: "Altın Renkli Aksesuar",
                  description:
                    "Premium altın renkli aksesuar ile lüks ve gösterişli görünüm",
                  icon: Star,
                },
                {
                  title: "Sağlam & Hafif",
                ...
                },
                {
                  ...
                  description:
                    "Altın, eloksal renk ve RAL boya, kabarcıklı/kabarcıksız varyasyonları",
                  icon: Grid3X3,
                },
                {
                  title: "Kolay Bakım",
          ...
          <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            ...
            <div className="divide-y divide-gray-200">
              {[
                ...
                ["Aksesuar Malzemesi", "Altın Renkli Aksesuar + Alüminyum"],
                ["Tasarım", "İstanbul Altın Dekoratif"],
                [
                  "Yüzey Seçenekleri",
                  "Altın aksesuar, eloksal renkler ve RAL boya seçenekleri",
                ],
                [
                  "Kullanım",
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                "Lüks merdiven korkulukları",
                "Premium ofis ve showroom tasarımları",
                "Yüksek kalite konut projelerinde estetik çözümler",
                "Altın aksesuar detaylı mimari tasarım projeleri",
                "Özel ve prestijli ticari alanlar",
              ].map((area, index) => (
                <div
                  key={index}
          ...
          <div className="space-y-6">
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-blue-800">
                ...
                <li>• İstanbul altın aksesuar tasarımının doğru yönlenmesine dikkat edin</li>
              </ul>
            </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-green-800">
                ...
                <li>• Altın aksesuar detaylarını özenle temizleyin</li>
                <li>• Dekoratif desenli yüzeyleri dikkatli temizleyin</li>
                <li>
        ...
        return (
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-4">
              {[
                "1 adet Pleksiglas Korkuluk Dikme (2544 İstanbul Model)",
                "İstanbul altın dekoratif özel tasarım",
                "Premium altın renkli aksesuar",
                "Dekoratif desenler ve lüks görünüm",
      ...
      case "faq":
        return (
          <div className="space-y-4">
            {[
              {
                q: "İstanbul tasarımının altın aksesuar özellikleri nelerdir?",
                a: "İstanbul modeli premium altın renkli aksesuar ile lüks görünüm sunar. Dekoratif desenler ve premium finish bir arada özel tasarım sunuyor.",
              },
              {
                q: "Bu model hangi alanlarda kullanılır?",
                a: "Lüks korkuluklar, premium ofis tasarımları, yüksek kalite konut projeleri ve özel prestijli ticari alanlarda idealdir.",
              },
              {
                q: "Altın aksesuar nasıl temizlenir?",
                a: "Mikrofiber bez ile nötr deterjan kullanarak altın aksesuar detayları ve dekoratif desenli yüzeyler özenle temizlenmelidir.",
              },
            ].map((faq, index) => (
              <div
                key={index}
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  Pleksiglas Korkuluk Dikme – 2544 İstanbul Model
                </h1>
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-8">
                  İstanbul modeli altın renkli aksesuar ile lüks görünüm sunan
                  pleksiglas korkuluk dikmesi. Dekoratif desenler ve premium
                  finish bir arada.
                </p>
              </div>
