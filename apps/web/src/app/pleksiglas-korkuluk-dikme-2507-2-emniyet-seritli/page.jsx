...
export default function PleksiDikme2507EmniyetSeritliPage() {
  ...
  useEffect(() => {
    document.title =
      "Pleksiglas Korkuluk Dikme 2507 2 Emniyet Şeritli Model | Walmco";
    ...
    metaDescription.content =
      "2507 2 Emniyet Şeritli model pleksiglas korkuluk dikme. Güvenlik şeritleri, dayanıklı yapı, eloksal aksesuar. Hızlı kargo, garanti.";
  ...
  const productImages = [
    {
      url: "https://ucarecdn.com/1d0b24c7-6861-4785-a1e8-11748b924139/-/format/auto/",
      alt: "Pleksiglas korkuluk dikme 2507 2 Emniyet Şeritli model",
      title: "Ana Görünüm",
    },
  ];
  ...
  const handleQuoteRequest = () => {
    const productInfo = {
      name: "Pleksiglas Korkuluk Dikme – 2507 2 Emniyet Şeritli Model",
      category: "Pleksi Korkuluk Dikmeleri",
      description: "Güvenlik şeritleri, dayanıklı yapı, eloksal aksesuar. Hızlı kargo, garanti.",
      image: "https://ucarecdn.com/1d0b24c7-6861-4785-a1e8-11748b924139/-/format/auto/",
  ...
  const handleWhatsAppClick = () => {
    const productName =
      "Pleksiglas Korkuluk Dikme – 2507 2 Emniyet Şeritli Model";
        ...
        <div className="relative w-full max-w-4xl">
          ...
          <div className="relative">
            <img
                  ...
                  productName="2507 seritli Model"
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                "Güvenlik gerektiren merdivenler",
                "Okul ve hastane balkonları",
                "Kamu binası korkulukları",
                "Güvenlik odaklı projeler",
                "Yüksek trafik alanları",
              ].map((area, index) => (
                <div
                  key={index}
          ...
          <div className="space-y-6">
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-blue-800">
                ...
                <li>
                  • Emniyet şeritlerinin doğru konumlandırılmasına dikkat edin
                </li>
              </ul>
            </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-green-800">
                ...
                <li>• Emniyet şeritlerini düzenli kontrol edin</li>
                <li>
        ...
        return (
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-4">
              {[
                "1 adet Pleksiglas Korkuluk Dikme (2507 2 Emniyet Şeritli Model)",
                "2 adet emniyet şeridi entegreli tasarım",
      ...
      case "faq":
        return (
          <div className="space-y-4">
            {[
              {
                q: "Emniyet şeritleri ne işe yarar?",
                a: "Emniyet şeritleri güvenlik amaçlı görünürlüğü artırır ve çarpma riskini azaltır. Özellikle yoğun kullanım alanlarında önemlidir.",
              },
              {
                q: "Şerit sayısı değiştirilebilir mi?",
                a: "Bu model 2 emniyet şeridi ile standart gelir. Farklı şerit sayıları için özel üretim seçenekleri mevcuttur.",
              },
              {
                q: "Hangi alanlarda kullanılmalı?",
                a: "Güvenlik gerektiren alanlarda, kamu binalarında ve yoğun trafik olan mekânlarda kullanımı önerilir.",
              },
            ].map((faq, index) => (
              <div
                key={index}
        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              {
                name: "Emniyet Şeridi Sistemleri",
                image:
                ...
                <div className="flex items-center space-x-4 mb-6">
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-gray-600 ml-2">
                      (4.6 • 22 değerlendirme)
                    </span>
                  </div>
                </div>

                <p className="text-lg text-gray-600 leading-relaxed mb-8">
                  2 emniyet şeridi ile güvenlik odaklı tasarım sunan pleksiglas
                  korkuluk dikmesi. Yüksek trafik alanları ve güvenlik
                  gerektiren projeler için ideal.
                </p>
              </div>
