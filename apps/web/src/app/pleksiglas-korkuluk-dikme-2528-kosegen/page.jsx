...
export default function PleksiDikme2528KosegenPage() {
  ...
  useEffect(() => {
    document.title = "Pleksiglas Korkuluk Dikme 2528 Köşegen Model | Walmco";
    ...
    metaDescription.content =
      "2528 Köşegen model pleksiglas korkuluk dikme. Köşegen geometrik tasarım, modern görünüm, eloksal aksesuar. Hızlı kargo, garanti.";
  ...
  const productImages = [
    {
      url: "https://ucarecdn.com/45734f9c-ab32-4dd5-a73f-aa20107f53de/-/format/auto/",
      alt: "Pleksiglas korkuluk dikme 2528 Köşegen model",
      title: "Ana Görünüm",
    },
  ];
  ...
  const handleQuoteRequest = () => {
    const productName = "Pleksiglas Korkuluk Dikme – 2528 Köşegen Model";
        ...
        <div className="relative w-full max-w-4xl">
          ...
          <div className="relative">
            <img
                  ...
                  productName="2528 kosegen Model"
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                "Çağdaş geometrik merdiven korkulukları",
                "Modern ofis ve ticari yapı tasarımları",
                "Geometrik desenli dekoratif projeler",
                "Çağdaş mimari çözümler",
                "Modern konut ve loft projeleri",
              ].map((area, index) => (
                <div
                  key={index}
          ...
          <div className="space-y-6">
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-blue-800">
                ...
                <li>• Köşegen deseninin doğru yönlenmesine dikkat edin</li>
              </ul>
            </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-green-800">
                ...
                <li>• Köşegen geometrik deseninin detaylarını özenle temizleyin</li>
                <li>
        ...
        return (
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-4">
              {[
                "1 adet Pleksiglas Korkuluk Dikme (2528 Köşegen Model)",
                "Köşegen geometrik tasarım deseni",
      ...
      case "faq":
        return (
          <div className="space-y-4">
            {[
              {
                q: "Köşegen tasarımının özellikleri nelerdir?",
                a: "Köşegen geometrik tasarım, modern görünüm ile çağdaş mimariye uygun çözüm sunar. Geometrik desenlerden hoşlanan modern tasarım arayanlar için idealdir.",
              },
              {
                q: "Bu model hangi alanlarda kullanılır?",
                a: "Çağdaş geometrik projeler, modern ofis tasarımları, geometrik desenli dekoratif alanlar ve çağdaş mimari projelerinde tercih edilir.",
              },
              {
                q: "Geometrik desen detayları zamanla bozulur mu?",
                a: "Kaliteli PMMA malzeme kullanıldığı için Köşegen tasarımının geometrik detayları uzun süre korunur. Düzenli temizlik önerilir.",
              },
            ].map((faq, index) => (
              <div
                key={index}
      ...
      case "related":
        return (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                name: "Geometrik Tasarım Aksesuarları",
                image:
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  Pleksiglas Korkuluk Dikme – 2528 Köşegen Model
                </h1>
                ...
                <div className="flex items-center space-x-4 mb-6">
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-gray-600 ml-2">
                      (4.5 • 26 değerlendirme)
                    </span>
                  </div>
                </div>

                <p className="text-lg text-gray-600 leading-relaxed mb-8">
                  Köşegen desenli geometrik tasarım ile modern görünüm sunan
                  pleksiglas korkuluk dikmesi. Çağdaş mimariye uygun fonksiyonel
                  çözüm.
                </p>
              </div>
