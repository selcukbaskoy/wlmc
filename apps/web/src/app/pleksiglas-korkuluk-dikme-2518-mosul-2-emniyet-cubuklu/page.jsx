...
export default function PleksiDikme2518MosulPage() {
  ...
  useEffect(() => {
    document.title =
      "Pleksiglas Korkuluk Dikme 2518 Mosul 2 Emniyet Çubuklu Model | Walmco";
    ...
    metaDescription.content =
      "2518 Mosul model pleksiglas korkuluk dikme. 2 emniyet çubuklu güvenlik odaklı tasarım, dayanıklı yapı, eloksal aksesuar. Hızlı kargo, garanti.";
  ...
  const productImages = [
    {
      url: "https://ucarecdn.com/d9481075-d262-4d84-9255-b779789b818f/-/format/auto/",
      alt: "Pleksiglas korkuluk dikme 2518 Mosul 2 Emniyet Çubuklu model",
      title: "Ana Görünüm",
    },
  ];
  ...
  const handleQuoteRequest = () => {
    const productInfo = {
      name: "Pleksiglas Korkuluk Dikme – 2518 Mosul 2 Emniyet Çubuklu Model",
      category: "Pleksi Korkuluk Dikmeleri",
      description: "2518 Mosul model pleksiglas korkuluk dikme. 2 emniyet çubuklu güvenlik odaklı tasarım, dayanıklı yapı, eloksal aksesuar. Hızlı kargo, garanti.",
      image: "https://ucarecdn.com/d9481075-d262-4d84-9255-b779789b818f/-/format/auto/",
  ...
  const getRandomRelatedProducts = (count = 3) => {
    const currentProductId = 41; // Bu ürünün ID'si
  ...
  const handleWhatsAppClick = () => {
    const productName =
      "Pleksiglas Korkuluk Dikme – 2518 Mosul 2 Emniyet Çubuklu Model";
        ...
        <div className="relative w-full max-w-4xl">
          ...
          <div className="relative">
            <img
                  ...
                  productName="2518 cubuklu Model"
        ...
        return (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                {
                  title: "2 Emniyet Çubuklu Tasarım",
                  description:
                    "Çift emniyet çubuğu ile gelişmiş güvenlik ve dayanıklılık",
                  icon: Shield,
                },
                {
                  title: "Sağlam & Hafif",
                ...
                },
                {
                  ...
                  description:
                    "Eloksal renk ve RAL boya, emniyet çubuklu varyasyonları",
                  icon: Grid3X3,
                },
                {
                  title: "Kolay Bakım",
        ...
        return (
          <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            ...
            <div className="divide-y divide-gray-200">
              {[
                ["Model", "2518 Mosul 2 Emniyet Çubuklu"],
                ["Gövde Malzemesi", "Pleksiglas (PMMA)"],
                ["Aksesuar Malzemesi", "Alüminyum (eloksal kaplama)"],
                ["Tasarım", "2 Emniyet Çubuklu"],
                ["Güvenlik Özellikleri", "Çift emniyet çubuğu sistemi"],
                [
                  "Yüzey Seçenekleri",
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                "Kamu binaları ve ofis merkezleri",
                "Merdiven ve rampa korkulukları",
                "Çocuk güvenliği odaklı projeler",
                "Premium konut projeleri",
              ].map((area, index) => (
                <div
                  key={index}
        ...
        return (
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-4">
              {[
                "1 adet Pleksiglas Korkuluk Dikme (2518 Mosul 2 Emniyet Çubuklu Model)",
      ...
      case "faq":
        return (
          <div className="space-y-4">
            {[
              {
                q: "2 emniyet çubuğu ne sağlar?",
                a: "Çift emniyet çubuğu sistemi ek güvenlik sağlar ve özellikle yüksek trafik alanları veya çocuk güvenliği gerektiren projelerde tercih edilir.",
              },
              {
                ...
                <div className="flex items-center space-x-4 mb-6">
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-gray-600 ml-2">
                      (4.6 • 15 değerlendirme)
                    </span>
                  </div>
                </div>

                <p className="text-lg text-gray-600 leading-relaxed mb-8">
                  2 emniyet çubuğu ile güvenlik odaklı tasarım sunan pleksiglas
                  korkuluk dikmesi. Yüksek trafik alanları ve güvenlik
                  gerektiren projeler için ideal çözüm.
                </p>
              </div>
