...
export default function PagesContentPage() {
  ...
  const { data, loading, error } = useQuery({
    queryKey: ['admin-content', 'page', page, search, status],
    queryFn: async () => {
  ...
  const handleEdit = (id) => {
    window.location.href = `/admin/content/pages/edit/${id}`;
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-gray-600">Statik sayfalarınızı yönetin</p>
        </div>
        <a
        ...
        <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-4">
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Sayfa başlığı veya içerik ara..."
                value={search}
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">Henüz sayfa yok</h3>
          <p className="text-gray-600 mb-4">İlk sayfanızı oluşturarak başlayın</p>
          <a
            href="/admin/content/pages/new"
