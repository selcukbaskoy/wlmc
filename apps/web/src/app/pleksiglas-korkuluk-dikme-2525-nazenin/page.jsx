...
export default function PleksiDikme2525NazeninPage() {
  ...
  useEffect(() => {
    document.title = "Pleksiglas Korkuluk Dikme 2525 Nazenin Model | Walmco";
    ...
    metaDescription.content =
      "2525 Nazenin model pleksiglas korkuluk dikme. Nazenin özel tasarımı, zarif ve şık görünüm, eloksal aksesuar. Hızlı kargo, garanti.";
  ...
  const productImages = [
    {
      url: "https://ucarecdn.com/69133eaf-ad2b-4055-a456-4171dd824190/-/format/auto/",
      alt: "Pleksiglas korkuluk dikme 2525 Nazenin model",
      title: "Ana Görünüm",
    },
  ];
  ...
  const handleQuoteRequest = () => {
    const productInfo = {
      name: "Pleksiglas Korkuluk Dikme – 2525 Nazenin Model",
      category: "Pleksi Korkuluk Dikmeleri",
      description:
        "2525 Nazenin model pleksiglas korkuluk dikme. Nazenin özel tasarımı, zarif ve şık görünüm, eloksal aksesuar. Hızlı kargo, garanti.",
      image:
        "https://ucarecdn.com/69133eaf-ad2b-4055-a456-4171dd824190/-/format/auto/",
  ...
  const handleWhatsAppClick = () => {
    const productName = "Pleksiglas Korkuluk Dikme – 2525 Nazenin Model";
  ...
  const getRandomRelatedProducts = (count = 3) => {
    const currentProductId = 50; // 2525 Nazenin ürününün ID'si
        ...
        <div className="relative w-full max-w-4xl">
          ...
          <div className="relative">
            <img
                  ...
                  productName="2525 nazenin Model"
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                "Premium zarif merdiven korkulukları",
                "Lüks yatak odası ve özel alan tasarımları",
                "Sofistike dekoratif projeler",
                "İnce detaylı mimari çözümler",
                "Şık ve modern konut projeleri",
              ].map((area, index) => (
                <div
                  key={index}
          ...
          <div className="space-y-6">
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-blue-800">
                ...
                <li>• Nazenin deseninin doğru yönlenmesine dikkat edin</li>
              </ul>
            </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-green-800">
                ...
                <li>• Nazenin deseninin ince detaylarını özenle temizleyin</li>
                <li>
        ...
        return (
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-4">
              {[
                "1 adet Pleksiglas Korkuluk Dikme (2525 Nazenin Model)",
                "Nazenin özel tasarımı ile zarif detaylar",
      ...
      case "faq":
        return (
          <div className="space-y-4">
            {[
              {
                q: "Nazenin tasarımının özellikleri nelerdir?",
                a: "Nazenin tasarımı, zarif ve şık görünüm ile ince detaylar sunar. Premium estetik ve sofistike tasarım arayanlar için idealdir.",
              },
              {
                q: "Bu model hangi alanlarda kullanılır?",
                a: "Premium zarif projeler, lüks konut tasarımları, sofistike dekoratif alanlar ve şık mimari projelerinde tercih edilir.",
              },
              {
                q: "İnce detaylar zamanla bozulur mu?",
                a: "Kaliteli PMMA malzeme kullanıldığı için Nazenin tasarımının ince detayları uzun süre korunur. Düzenli temizlik önerilir.",
              },
            ].map((faq, index) => (
              <div
                key={index}
      ...
      case "related":
        return (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                name: "Zarif Tasarım Aksesuarları",
                image:
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  Pleksiglas Korkuluk Dikme – 2525 Nazenin Model
                </h1>
                ...
                <div className="flex items-center space-x-4 mb-6">
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-gray-600 ml-2">
                      (4.8 • 38 değerlendirme)
                    </span>
                  </div>
                </div>

                <p className="text-lg text-gray-600 leading-relaxed mb-8">
                  Nazenin modeli özel tasarımı ile zarif ve şık görünüm sunan
                  pleksiglas korkuluk dikmesi. İnce detaylar ve premium estetik
                  bir arada.
                </p>
              </div>
