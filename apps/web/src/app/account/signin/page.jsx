...
function MainComponent() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessages = {
        CredentialsSignin: "Hatalı e-posta veya şifre.",
        AccessDenied: "Giriş izniniz bulunmuyor.",
        Configuration: "Giriş şu anda çalışmıyor. Lütfen daha sonra tekrar deneyin.",
      };
    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 p-4">
      ...
      >
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-gray-600">CMS yönetim paneline giriş yapın</p>
        </div>
