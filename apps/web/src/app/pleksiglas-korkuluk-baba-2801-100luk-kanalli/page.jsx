...
export default function PleksiBaba2801KanalliPage() {
  ...
  useEffect(() => {
    document.title = "Pleksiglas Korkuluk Baba 2801 100'lük Kanallı Model | Walmco";
  }, []);

  const handleQuoteRequest = () => {
    const productInfo = {
      name: "Pleksiglas Korkuluk Baba – 2801 100'lük Kanallı Model",
      category: "Pleksi Korkuluk Babaları",
      description: "100'lük kanallı model, özel tasarım ve premium kalite. Aksesuar seçenekleri ile uyumlu.",
      image: "https://walmco.com/urunler/Plexsi%20Babalar/2801%20100%20l%C3%BCk%20kanall%C4%B1%20pleksi%20baba.png",
  ...
  const handleWhatsAppClick = () => {
    const productName = "Pleksiglas Korkuluk Baba – 2801 100'lük Kanallı Model";
        ...
        <div className="bg-white border-b">
          <div className="max-w-7xl mx-auto px-4 py-3">
            <nav className="flex items-center space-x-2 text-sm">
              ...
              <span className="text-gray-300">/</span>
              <span className="text-gray-900">2801 100'lük Kanallı Model</span>
            </nav>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              <div className="relative aspect-square overflow-hidden rounded-lg bg-gray-50">
                <img
                  ...
                  src="https://ucarecdn.com/8b1b6c1c-8c42-473c-a983-fb90c928d72a/-/format/auto/"

                  alt="Pleksiglas Korkuluk Baba 2801 100'lük Kanallı Model"

                  productName="2801 Kanalli Model"
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl p-6 shadow-sm">
                ...
                <p className="text-lg text-gray-600 mb-4">2801 100'lük Kanallı Model</p>
                ...
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <span className="text-sm text-gray-500">(4.8 • 125 değerlendirme)</span>
                </div>

                <p className="text-gray-600 leading-relaxed mb-6">
                  2801 100'lük kanallı model pleksiglas korkuluk babası. Kanallı özel tasarım ile 
                  fonksiyonel ve estetik görünüm sunan, dayanıklı yapısıyla güvenli çözüm.
                </p>
                  ...
                  <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-2">
                        100'lük Kanallı Tasarım
                      </h3>
                      <p className="text-gray-600">
                        100'lük kanallı özel tasarım ile su akışı ve estetik görünüm
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-3">
                      <div className="flex justify-between py-2 border-b border-gray-100">
                        ...
                        <span className="text-gray-900">2801 100'lük Kanallı</span>
                      </div>
                      <div className="flex justify-between py-2 border-b border-gray-100">
                      ...
                      <div className="flex justify-between py-2 border-b border-gray-100">
                        ...
                        <span className="text-gray-900">100'lük Kanallı</span>
                      </div>
                    </div>
                    <div className="space-y-3">
                      <div className="flex justify-between py-2 border-b border-gray-100">
              ...
              {activeTab === "uygulama" && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {[
                      "Kanallı merdiven korkuluk sistemleri",
                      "Su akışı gerektiren korkuluk uygulamaları", 
                      "Modern bina tasarımları",
                      "Fonksiyonel korkuluk çözümleri",
                    ].map((area, index) => (
