...
export default function PleksiBaba2846BurguluKanalliPage() {
  ...
  useEffect(() => {
    document.title =
      "Pleksiglas Korkuluk Baba 2846 Burgulu Kanallı Model | Walmco";
    ...
    metaDescription.content =
      "2846 Burgulu kanallı model pleksiglas korkuluk babası. Burgulu kanallı özel tasarım, fonksiyonel yapı, altın aksesuar, premium kalite. Hızlı kargo, garanti.";
  ...
  const productImages = [
    {
      url: "https://walmco.com/urunler/Plexsi%20Babalar/2846%20burgulu%20kanall%C4%B1%20pleksi%20baba.png",
      alt: "Pleksiglas korkuluk baba 2846 Burgulu kanallı model",
      title: "Ana Görünüm",
    },
  ];
  ...
  const handleQuoteRequest = () => {
    const productName = "Pleksiglas Korkuluk Baba – 2846 Burgulu Kanallı Model";
        ...
        <div className="relative w-full max-w-4xl">
          ...
          <div className="relative">
            <img
              ...
              productName="2846 Kanalli Model"
        ...
        return (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                {
                  title: "Burgulu Kanallı Tasarım",
                  description:
                    "Burgulu kanallı özel tasarım ile fonksiyonel ve estetik görünüm",
                  icon: Star,
                },
                {
                  title: "Fonksiyonel Yapı",
                  description:
                    "Su akışı ve havalandırma özelliği ile pratik çözüm",
                  icon: Shield,
                },
                {
                  title: "Altın Aksesuar",
                  description: "Premium kalite altın aksesuar ile lüks görünüm",
                  icon: Grid3X3,
                },
                {
                  title: "Premium Kalite",
                  description:
                    "PMMA pleksiglas malzemesi ile uzun ömür garanti",
                  icon: Check,
                },
              ].map((feature, index) => (
                <div
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                "Burgulu kanallı merdiven korkuluk sistemleri",
                "Su akışı gerektiren korkuluk uygulamaları",
                "Fonksiyonel tasarım projeler",
                "Premium estetik görünüm gerektiren alanlar",
                "Modern ve çağdaş mimari uygulamaları",
              ].map((area, index) => (
                <div
                  key={index}
          ...
          <div className="space-y-6">
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-blue-800">
                ...
                <li>
                  • Burgulu kanallı tasarımın doğru hizalama kontrolü yapın
                </li>
                <li>• Su akış yönünü dikkate alarak montaj yapın</li>
              </ul>
            </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-green-800">
                ...
                <li>• Altın aksesuar için özel temizlik ürünleri önerilir</li>
                <li>• Burgulu kanallar için özel fırça kullanın</li>
                <li>
        ...
        return (
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-4">
              {[
                "1 adet Pleksiglas Korkuluk Baba (2846 Burgulu Kanallı Model)",
                "Burgulu kanallı özel tasarım",
      ...
      case "faq":
        return (
          <div className="space-y-4">
            {[
              {
                q: "Burgulu kanallı tasarımının avantajları nelerdir?",
                a: "Burgulu kanallı tasarım hem estetik görünüm sunar hem de fonksiyonel özellikleri ile su akışı ve havalandırma imkanı sağlar.",
              },
              {
                q: "Bu model hangi alanlarda kullanılır?",
                a: "Burgulu kanallı korkuluklar, su akışı gerektiren alanlar, premium estetik projeler ve modern mimari uygulamalarda idealdir.",
              },
              {
                q: "Altın aksesuar bakımı nasıl yapılır?",
                a: "Altın aksesuar için özel temizlik ürünleri kullanılmalı, aşındırıcı kimyasallardan kaçınılmalıdır. Burgulu kanallar için özel fırça kullanın.",
              },
            ].map((faq, index) => (
              <div
                key={index}
        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              {
                name: "2801 100'lük Kanallı Model",
                image:
                  "https://ucarecdn.com/8b1b6c1c-8c42-473c-a983-fb90c928d72a/-/format/auto/",
              },
              {
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  Pleksiglas Korkuluk Baba – 2846 Burgulu Kanallı Model
                </h1>
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-8">
                  2846 Burgulu kanallı model pleksiglas korkuluk babası. Burgulu
                  kanallı özel tasarım ile fonksiyonel ve estetik görünüm, altın
                  aksesuar ile premium çözüm.
                </p>
              </div>
