...
export default function PleksiglasKorkulukDikme3501BurguKanal100LukDiamond() {
  ...
  const images = [
    "https://walmco.com/urunler/pleksi%20diamond%20seri%20%C3%BCr%C3%BCnler/3500%20burgu%20kanal%20100%20l%C3%BCk%20pleksi%20dikme.png",
  ];

  const handleQuoteRequest = () => {
    const productInfo = {
      name: "3501 Burgu Kanal 100 Lük Diamond seri pleksiglas korkuluk dikme",
      model: "3501 Burgu Kanal 100 Lük",
  ...
  const handleWhatsApp = () => {
    const message = `Merhaba, 3501 Burgu Kanal 100 Lük Diamond seri pleksiglas korkuluk dikme ürünü hakkında bilgi almak istiyorum.\n\nÜrün Detayları:\n- Model: 3501 Burgu Kanal 100 Lük\n- Boy: 1000 mm\n- Seri: Diamond Seri\n- Malzeme: Pleksiglas (PMMA)\n\n\nDetaylı bilgi ve teklif almak istiyorum.`;
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <nav className="text-sm text-gray-600 mb-6">
          <ol className="flex items-center space-x-2">
            ...
            <li>/</li>
            <li className="text-gray-900">3501 Burgu Kanal 100 Lük</li>
          </ol>
        </nav>
            ...
            <div className="relative">
              <div className="overflow-hidden rounded-lg bg-gray-100">
                <img
                  ...
                  alt="3501 Burgu Kanal 100 Lük Diamond seri Pleksiglas Korkuluk Dikme"
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">
                3501 Burgu Kanal 100 Lük Diamond Seri Pleksiglas Korkuluk Dikme
              </h1>
              <div className="flex items-center space-x-4">
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-sm text-gray-600">4.9 (128 değerlendirme)</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <p className="text-gray-700 leading-relaxed">
                3501 Burgu Kanal 100 Lük model pleksiglas korkuluk dikmesi. Diamond seri özel tasarımı ile premium görünüm sunan, burgu kanal detayı ile estetik çözüm.
              </p>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start">
                    ...
                    Burgu kanal tasarım ile estetik görünüm
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-green-500 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    100 Lüks model boyutunda
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-green-500 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <dd className="mt-1 text-lg font-semibold text-gray-900">3501 Burgu Kanal 100 Lük</dd>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <dt className="text-sm font-medium text-gray-500">Boy</dt>
                    <dd className="mt-1 text-lg font-semibold text-gray-900">1000 mm</dd>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              <img
                   src="https://walmco.com/urunler/pleksi%20diamond%20seri%20%C3%BCr%C3%BCnler/3500%20k%C3%B6%C5%9Fegen%20100%20lik%20%C5%9Fi%C5%9Fe%20dikme.png"
                   alt="3500 Köşegen 100 Lük Şişe Dikme Diamond seri"
                   productName="3501 diamond Model"
                   className="w-full h-48 object-cover"
              
                 />
              <div className="p-4">
                <h3 className="font-semibold text-gray-900 mb-2">3500 Köşegen 100 Lük Şişe Dikme</h3>
                <p className="text-gray-600 text-sm mb-3">Diamond seri köşegen tasarım</p>
                <a
                  href="/pleksiglas-korkuluk-dikme-3500-kosegen-100-luk-sise-dikme-diamond"
