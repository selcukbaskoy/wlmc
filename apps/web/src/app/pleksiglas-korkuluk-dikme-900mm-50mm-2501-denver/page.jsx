...
export default function PleksiDikmePage() {
  ...
  const [imageZoom, setImageZoom] = useState(1); // Add zoom state

  useEffect(() => {
    // SEO Meta Tags
    document.title =
      "Pleksiglas Korkuluk Dikme 900mm Ø50mm - 2501 Denver Model | Walmco";
    ...
    metaDescription.content =
      "Premium pleksiglas korkuluk dikme 900mm yükseklik, Ø50mm çap. Kabarcıklı/kabarcıksız seçenekleri, eloksal aksesuar. Hızlı kargo, garanti.";
    ...
    ogTitle.content = "Pleksiglas Korkuluk Dikme 900mm - Premium Kalite";
    ...
    ogDescription.content =
      "Modern görünüm sunan pleksiglas korkuluk dikmesi. Kabarcıklı/kabarcıksız seçenekleri ile özelleştirilebilir tasarım.";
    ...
    ogImage.content =
      "https://ucarecdn.com/7cc52583-80c4-4743-80bb-124c6562f162/-/format/auto/";
    ...
    script.textContent = JSON.stringify({
      ...
      "@type": "Product",
      name: "Pleksiglas Korkuluk Dikme 900mm Ø50mm - 2501 Denver Model",
      image: [
        "https://ucarecdn.com/7cc52583-80c4-4743-80bb-124c6562f162/-/format/auto/",
      ],
      description:
        "Şeffaf ve modern görünüm sunan pleksiglas korkuluk dikmesi; 900 mm yükseklik, Ø50 mm çap. Kabarcıklı/kabarcıksız gövde seçenekleri.",
      sku: "2501-DENVER",
      mpn: "2501",
      brand: {
        "@type": "Brand",
      ...
      offers: {
        "@type": "Offer",
        url: "https://walmco.com/pleksiglas-korkuluk-dikme-900mm-50mm-2501-denver",
        priceCurrency: "TRY",
        price: "850",
  ...
  const productImages = [
    {
      url: "https://ucarecdn.com/7cc52583-80c4-4743-80bb-124c6562f162/-/format/auto/",
      alt: "Pleksiglas korkuluk dikme 900 mm, Ø50 mm, kabarcıklı/kabarcıksız, alüminyum eloksal aksesuar",
      title: "Ana Görünüm",
    },
  ];
  ...
  const handleQuoteRequest = () => {
    const productInfo = {
      name: "Pleksiglas Korkuluk Dikme – 900 mm, Ø50 mm (2501 Denver Model)",
      category: "Pleksi Korkuluk Dikmeleri",
      description: "Premium pleksiglas korkuluk dikme 900mm yükseklik, Ø50mm çap. Kabarcıklı/kabarcıksız seçenekleri, eloksal aksesuar. Hızlı kargo, garanti.",
      image: "https://ucarecdn.com/7cc52583-80c4-4743-80bb-124c6562f162/-/format/auto/",
  ...
  const handleWhatsAppClick = () => {
    const productName =
      "Pleksiglas Korkuluk Dikme – 900 mm, Ø50 mm (2501 Denver Model)";
  ...
  const getRandomRelatedProducts = (count = 3) => {
    const currentProductId = 25; // Bu ürünün ID'si
          ...
          <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            ...
            <div className="divide-y divide-gray-200">
              {[
                ...
                ["Gövde Seçenekleri", "Kabarcıklı / Kabarcıksız"],
                [
                  "Yüzey Seçenekleri",
                ...
                ["Uyum", "50 mm bağlantı elemanlarıyla çalışır"],
              ].map(([key, value], index) => (
                <div
                  key={index}
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                "Balkon küpeşteleri",
                "Galeri boşlukları",
                "Vitrin & showroom ayraçları",
                "Otel-lobi bölücüleri",
              ].map((area, index) => (
                <div
                  key={index}
        ...
        return (
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-4">
              {[
                "1 adet Pleksiglas Korkuluk Dikme (900 mm, Ø50 mm)",
      ...
      case "faq":
        return (
          <div className="space-y-4">
            {[
              {
                q: "Kabarcıklı vs kabarcıksız farkı nedir?",
                a: "Kabarcıklı model ışığı kırarak dekoratif derinlik etkisi yaratır. Kabarcıksız model ise tamamen şeffaf ve minimal görünüm sunar.",
              },
              {
                q: "Aksesuar renkleri değişir mi?",
                a: "Evet, eloksal ve RAL boya seçenekleri mevcuttur. Projenize uygun renk seçimi yapabilirsiniz.",
              },
              {
                q: "Dış mekânda kullanım mümkün mü?",
                a: "Proje şartlarına göre değerlendirilir. UV koruma ve hava koşullarına uygun aksesuar önerileri sunulur.",
              },
            ].map((faq, index) => (
              <div
                key={index}
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  Pleksiglas Korkuluk Dikme – 900 mm, Ø50 mm
                </h1>
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-8">
                  ...
                  900 mm yükseklik, Ø50 mm çap. Kabarcıklı/kabarcıksız gövde
                  seçenekleri ile aksesuarlar alüminyum eloksal kaplama.
                </p>
              </div>
              ...
              {/* Purchase Section - Remove price, change button */}
