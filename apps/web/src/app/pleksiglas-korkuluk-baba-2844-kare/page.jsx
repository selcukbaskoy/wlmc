...
export default function PleksiBaba2844KarePage() {
  ...
  useEffect(() => {
    document.title = "Pleksiglas Korkuluk Baba 2844 Kare Model | Walmco";
    ...
    metaDescription.content =
      "2844 Kare model pleksiglas korkuluk babası. Kare geometrik tasarım ile modern görünüm sunan, altın aksesuar ile estetik çözüm.";
  ...
  const productImages = [
    {
      url: "https://walmco.com/urunler/Plexsi%20Babalar/2844%20kare%20pleksi%20babaa.png",
      alt: "Pleksiglas korkuluk baba 2844 Kare model",
      title: "Ana Görünüm",
    },
  ];
  ...
  const handleQuoteRequest = () => {
    const productInfo = {
      name: "Pleksiglas Korkuluk Baba – 2844 Kare Model",
      category: "Pleksi Korkuluk Babaları",
      description: "Kare geometrik tasarım ile modern görünüm sunan, altın aksesuar ile estetik çözüm.",
      image: "https://walmco.com/urunler/Plexsi%20Babalar/2844%20kare%20pleksi%20babaa.png",
  ...
  const handleWhatsAppClick = () => {
    const productName = "Pleksiglas Korkuluk Baba – 2844 Kare Model";
        ...
        return (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                {
                  title: "Kare Geometrik Tasarım",
                  description:
                    "Kare geometrik tasarım ile modern görünüm sunan estetik çözüm",
                  icon: Grid3X3,
                },
                {
                  title: "Sağlam & Hafif",
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                "Kare geometrik tasarım gerektiren projeler",
                "Çağdaş bina tasarımları",
                "Estetik ve fonksiyonel korkuluk çözümleri",
                "Geometrik tasarım odaklı uygulamalar",
              ].map((area, index) => (
                <div
                  key={index}
          ...
          <div className="space-y-6">
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-blue-800">
                ...
                <li>• Kare geometrik tasarımın doğru hizalama kontrolü yapın</li>
              </ul>
            </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-green-800">
                <li>• Nötr temizlik ürünleri kullanın</li>
                <li>• Aşındırıcı kimyasallardan kaçının</li>
                <li>• Düzenli temizlik yapın</li>
                <li>• Kare geometrik yapıyı koruyun</li>
              </ul>
            </div>
          </div>
        );
      ...
      case "package":
        return (
          <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            ...
            <div className="divide-y divide-gray-200">
              {[
                ["Pleksiglas Korkuluk Baba", "1 Adet"],
                ["Altın Aksesuar", "1 Adet"],
                ["Montaj Vidaları", "4 Adet"],
                ["Kullanım Kılavuzu", "1 Adet"],
                ["Garanti Belgesi", "1 Adet"],
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {[
                {
                  question: "Kare model hangi projeler için uygundur?",
                  answer: "Kare geometrik tasarım gerektiren modern projeler için idealdir.",
                },
                {
                  question: "Dış mekânda kullanılabilir mi?",
                  answer: "Proje bazında doğrulanması gerekir, genellikle iç mekân için tasarlanmıştır.",
                },
                {
                  question: "Renk seçenekleri nelerdir?",
                  answer: "Altın aksesuar, eloksal ve RAL boya seçenekleri mevcuttur.",
                },
              ].map((faq, index) => (
                <div
                  key={index}
        ...
        <div className="bg-white border-b">
          <div className="max-w-7xl mx-auto px-4 py-3">
            <nav className="flex items-center space-x-2 text-sm">
              ...
              <span className="text-gray-300">/</span>
              <span className="text-gray-900">2844 Kare Model</span>
            </nav>
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                Pleksiglas Korkuluk Baba – 2844 Kare Model
              </h1>
                ...
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  (4.7 • 142 değerlendirme)
                </span>
                  </div>
              </div>

                <p className="text-lg text-gray-600 leading-relaxed mb-8">
                2844 Kare model pleksiglas korkuluk babası. Kare geometrik
                tasarım ile modern görünüm sunan, altın aksesuar ile estetik
                çözüm.
              </p>
            </div>
