...
export default function PleksiglasKorkulukDikme3503Burgulu80LikDiamond() {
  ...
  const images = [
    "https://walmco.com/urunler/pleksi%20diamond%20seri%20%C3%BCr%C3%BCnler/3503%20burgulu%2080%20lik%20pleksi%20dikme.jpeg",
  ];

  const handleQuoteRequest = () => {
    const productInfo = {
      name: "Pleksiglas Korkuluk Dikme – 3503 Burgulu 80 Lik",
      category: "Pleksi Diamond Seri",
      description: "3503 Burgulu 80 Lik model pleksiglas korkuluk dikme. Diamond seri özel tasarımı ile premium görünüm. Hızlı kargo, garanti.",
      image: "https://walmco.com/urunler/pleksi%20diamond%20seri%20%C3%BCr%C3%BCnler/3503%20burgulu%2080%20lik%20pleksi%20dikme.jpeg",

      specifications: {
        "Model": "3503 Burgulu 80 Lik",
        "Boy": "800 mm",
  ...
  const handleWhatsApp = () => {
    const message = `Merhaba, 3503 Burgulu 80 Lik Diamond seri pleksiglas korkuluk dikme ürünü hakkında bilgi almak istiyorum.\n\nÜrün Detayları:\n- Model: 3503 Burgulu 80 Lik\n- Boy: 800 mm\n- Seri: Diamond Seri\n- Malzeme: Pleksiglas (PMMA)\n\n\nDetaylı bilgi ve teklif almak istiyorum.`;
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <nav className="text-sm text-gray-600 mb-6">
          <ol className="list-none p-0 inline-flex">
            ...
            <li className="flex items-center">
              <a href="/urunler/pleksi-diamond" className="hover:text-blue-600">Pleksi Diamond Seri</a>
              <span className="mx-2">/</span>
            </li>
            <li className="text-gray-900">3503 Burgulu 80 Lik</li>
          </ol>
        </nav>
            ...
            <div className="relative">
              <div className="overflow-hidden rounded-lg bg-gray-100">
                <img
                  ...
                  alt="3503 Burgulu 80 Lik Diamond Seri Pleksiglas Korkuluk Dikme"
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">
                Pleksiglas Korkuluk Dikme – 3503 Burgulu 80 Lik
              </h1>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-gray-600">4.8 (16 değerlendirme)</span>
              </div>
              <p className="text-gray-700 text-lg">
                3503 Burgulu 80 Lik model pleksiglas korkuluk dikmesi. Diamond seri özel tasarımı ile premium görünüm sunan, 
                burgulu detayı ile estetik çözüm.
              </p>
            </div>
          ...
          <div className="py-6">
            {activeTab === "ozellikler" && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-lg border">
                  <h3 className="font-semibold text-lg mb-3">Burgulu Tasarım</h3>
                  <p className="text-gray-600">Özel burgulu detayı ile estetik ve fonksiyonel tasarım</p>
                </div>
                <div className="bg-white p-6 rounded-lg border">
                  <h3 className="font-semibold text-lg mb-3">Diamond Seri</h3>
                  <p className="text-gray-600">Premium Diamond seri kalitesi ile lüks görünüm ve uzun ömür</p>
                </div>
                <div className="bg-white p-6 rounded-lg border">
                  <h3 className="font-semibold text-lg mb-3">80 Lik Model</h3>
                  <p className="text-gray-600">80 lik özel tasarım ile farklı projelerde kullanım imkanı</p>
                </div>
                <div className="bg-white p-6 rounded-lg border">
                  <h3 className="font-semibold text-lg mb-3">Premium Estetik</h3>
                  <p className="text-gray-600">Yüksek kalite malzeme ve işçilik ile premium estetik çözüm</p>
                </div>
              </div>
            )}
            ...
            {activeTab === "teknik" && (
              <div className="bg-white p-6 rounded-lg border">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <span className="font-medium">Model:</span> 3503 Burgulu 80 Lik
                  </div>
                  <div>
                    <span className="font-medium">Boy:</span> 800 mm
                  </div>
                  <div>
                    <span className="font-medium">Malzeme:</span> Pleksiglas (PMMA)
                  </div>
                  <div>
                    <span className="font-medium">Seri:</span> Diamond Seri
                  </div>
                  <div>
            ...
            {activeTab === "uygulama" && (
              <div className="bg-white p-6 rounded-lg border">
                ...
                <ul className="space-y-2 text-gray-600">
                  <li>• Lüks villa ve konak korkulukları</li>
                  <li>• Premium ofis ve işyeri güvenlik bariyerleri</li>
                  <li>• 5 yıldızlı otel ve restoran dekorasyonu</li>
                  <li>• Özel proje ve lüks konut projeleri</li>
                  <li>• VIP alanlar ve özel tasarım mekanlar</li>
                  <li>• Premium güvenlik sistemleri</li>
                </ul>
              </div>
            )}
              ...
              <div className="bg-white p-6 rounded-lg border">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-600">Uzman montaj ekibi tarafından hassas ve güvenli kurulum</p>
                  </div>
                  <div>
                    <h4 className="font-medium mb-2">Bakım</h4>
                    <p className="text-gray-600">Özel temizlik ürünleri ile düzenli bakım ve koruma</p>
                  </div>
                </div>
              </div>
            )}
            ...
            {activeTab === "paket" && (
              <div className="bg-white p-6 rounded-lg border">
                ...
                <ul className="space-y-2 text-gray-600">
                  <li>• Premium pleksiglas dikme gövdesi</li>
                  <li>• Eloksal alüminyum aksesuarlar</li>
                  <li>• Montaj vidaları ve bağlantı elemanları</li>
                  <li>• Detaylı montaj kılavuzu</li>
                  <li>• Garanti belgesi ve kalite sertifikası</li>
                </ul>
              </div>
            )}
              ...
              <div className="bg-white p-6 rounded-lg border">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-600">5 yıl garanti ile premium kalite ve uzun ömürlü kullanım sağlar.</p>
                  </div>
                  <div>
                    <h4 className="font-medium">Diamond seri farkı nedir?</h4>
                    <p className="text-gray-600">Premium malzeme kalitesi, özel tasarım detayları ve lüks görünüm sunar.</p>
                  </div>
                </div>
              </div>
            )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg border overflow-hidden hover:shadow-lg transition duration-200">
              <img
                   ...
                   alt="3501 Burgu Kanal 100 Lük"
                   productName="3503 diamond Model"
                   className="w-full h-48 object-cover"
              
                 />
              <div className="p-4">
                <h3 className="font-semibold text-lg mb-2">3501 Burgu Kanal 100 Lük</h3>
                ...
                <p className="text-gray-600 text-sm mb-3">Burgu kanal detayı ile premium Diamond seri</p>
            ...
            <div className="bg-white rounded-lg border overflow-hidden hover:shadow-lg transition duration-200">
              <img
                   ...
                   alt="3502 Twisted 100 Lük"
                   productName="3503 diamond Model"
                   className="w-full h-48 object-cover"
              
                 />
              <div className="p-4">
                <h3 className="font-semibold text-lg mb-2">3502 Twisted 100 Lük</h3>
                <div className="flex items-center mb-2">
                  <div className="flex text-yellow-400">
                    {[...Array(5)].map((_, i) => (
                      <svg key={i} className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                ...
                <p className="text-gray-600 text-sm mb-3">Twisted (burkulu) detayı ile premium Diamond seri</p>
                <button className="w-full bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 transition duration-200">
                  Ürünü İncele
                </button>
              </div>
