...
export default function PleksiDikme2540ErciyesPage() {
  ...
  useEffect(() => {
    document.title = "Pleksiglas Korkuluk Dikme 2540 Erciyes Model | Walmco";
    ...
    metaDescription.content =
      "2540 Erciyes model pleksiglas korkuluk dikme. Dekoratif tasarım, uzun form, detaylı işçilik, premium görünüm. Hızlı kargo, garanti.";
  ...
  const productImages = [
    {
      url: "https://ucarecdn.com/21e516ec-f8b7-4dd2-92a7-d87b67f6248e/-/format/auto/",
      alt: "Pleksiglas korkuluk dikme 2540 Erciyes model",
      title: "Ana Görünüm",
    },
  ];
  ...
  const handleQuoteRequest = () => {
    const productName = "Pleksiglas Korkuluk Dikme – 2540 Erciyes Model";
        ...
        <div className="relative w-full max-w-4xl">
          ...
          <div className="relative">
            <img
                  ...
                  productName="2540 erciyes Model"
          ...
          <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            ...
            <div className="divide-y divide-gray-200">
              {[
                ...
                ["Tasarım", "Erciyes Dekoratif Tasarım"],
                [
                  "Yüzey Seçenekleri",
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                "Premium ofis tasarımları",
                "Lüks konut projelerinde estetik çözümler",
                "Uzun form detaylı mimari tasarım projeleri",
                "Premium işçilik gerektiren ticari alanlar",
              ].map((area, index) => (
                <div
                  key={index}
          ...
          <div className="space-y-6">
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-blue-800">
                ...
                <li>• Erciyes dekoratif tasarımının doğru yönlenmesine dikkat edin</li>
              </ul>
            </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-green-800">
                ...
                <li>• Dekoratif detayların tüm kısımlarını özenle temizleyin</li>
                <li>
        ...
        return (
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-4">
              {[
                "1 adet Pleksiglas Korkuluk Dikme (2540 Erciyes Model)",
                "Erciyes dekoratif özel tasarım",
                "Detaylı işçilik ile uzun form",
      ...
      case "faq":
        return (
          <div className="space-y-4">
            {[
              {
                q: "Erciyes tasarımının özellikleri nelerdir?",
                a: "Erciyes modeli özel dekoratif tasarım ile estetik görünüm sunar. Uzun form ve detaylı işçilik ile premium görünüm sağlar.",
              },
              {
                q: "Bu model hangi alanlarda kullanılır?",
                a: "Dekoratif korkuluklar, premium ofis tasarımları, lüks konut projeleri ve premium işçilik gerektiren alanlarda idealdir.",
              },
              {
                q: "Dekoratif detaylar nasıl temizlenir?",
                a: "Mikrofiber bez ile nötr deterjan kullanarak dekoratif detayların tüm kısımları özenle temizlenmelidir.",
              },
            ].map((faq, index) => (
              <div
                key={index}
        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              {
                name: "Uzun Form Tasarım Dikmeler",
                image:
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  Pleksiglas Korkuluk Dikme – 2540 Erciyes Model
                </h1>
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-8">
                  Erciyes modeli özel dekoratif tasarım ile estetik görünüm
                  sunan pleksiglas korkuluk dikmesi. Uzun form ve detaylı
                  işçilik ile premium çözüm.
                </p>
              </div>
