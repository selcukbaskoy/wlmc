...
export const meta = () => [
  ...
  { name: "description", content: "İstanbul Sarıyer'de villa iç merdivenlerinde uygulanan şeffaf pleksi korkuluk sistemi. Fiyatlar, görseller ve proje detayları." },
  { name: "keywords", content: "sarıyer pleksi korkuluk, villa pleksi korkuluk, pleksi korkuluk fiyatları, şeffaf korkuluk" },
  { name: "robots", content: "index, follow" },
  { property: "og:title", content: "İstanbul Sarıyer Villa Korkuluk Projesi" },
  { property: "og:description", content: "Sarıyer villa projesinde şeffaf pleksi korkuluk uygulaması. Görseller ve teknik bilgiler." },
          ...
          <div className="space-y-8">
            <div className="prose max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                İstanbul Sarıyer'deki villa projesinde, iç merdivenlerde şeffaf pleksi korkuluk sistemi
