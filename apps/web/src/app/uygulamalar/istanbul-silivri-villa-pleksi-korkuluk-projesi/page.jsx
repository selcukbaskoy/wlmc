...
export const meta = () => [
  { title: "İstanbul Silivri Villa Pleksi Korkuluk Projesi - Walmco" },
  { name: "description", content: "İstanbul Silivri'de villa projesinde uygulanan şeffaf pleksi korkuluk sistemi. Fiyatlar, görseller ve proje detayları." },
  { name: "keywords", content: "silivri pleksi korkuluk, villa pleksi korkuluk, pleksi korkuluk fiyatları, şeffaf korkuluk" },
  { name: "robots", content: "index, follow" },
  { property: "og:title", content: "İstanbul Silivri Villa Pleksi Korkuluk Projesi" },
  { property: "og:description", content: "Silivri villa projesinde şeffaf pleksi korkuluk uygulaması. Görseller ve teknik bilgiler." },
  { property: "og:type", content: "website" },
];

export default function SilivriProjePage() {
  ...
  const images = [
    "https://walmco.com/uygulamalar/pleksi%20korkuluk%20en%20ucuzu.png",
    "https://walmco.com/uygulamalar/pleksi%20korkuluk%20fiyatlar%C4%B1.png",
    "https://walmco.com/uygulamalar/pleksi%20%C5%9Feffaf%20korkuluk.png",
  ];
  ...
  const features = [
    { icon: Eye, title: "Şeffaf Estetik", description: "Modern villa mimarisine uyumlu, ferah ve şık görünüm" },
    { icon: Shield, title: "Güvenli Yapı", description: "Dayanıklı pleksi ve mat alüminyum profil kombinasyonu" },
    { icon: Zap, title: "Hızlı Montaj", description: "Yerinde hızlı kurulum ve temiz işçilik" },
    { icon: Award, title: "Premium Malzeme", description: "CE sertifikalı komponentler ile uzun ömür" },
  ];

  const specifications = [
    { label: "Pleksi Kalınlığı", value: "10mm Şeffaf Pleksi" },
    { label: "Profil", value: "Mat Alüminyum" },
    { label: "Kullanım Alanı", value: "İç Mekân (Merdiven)" },
          ...
          <div className="space-y-8">
            <div className="prose max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                İstanbul Silivri'deki villa projesinde, iç merdivenlerde şeffaf pleksi korkuluk sistemi
                uygulanmıştır. Pleksi panel ve alüminyum profil kombinasyonu, hem güvenliği hem de modern
                estetiği bir arada sunar.
              </p>
            </div>
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {images.map((src, i) => (
                <img key={i} src={src} alt={`Silivri pleksi korkuluk ${i + 1}`} className="w-full h-40 object-cover rounded-lg" />
              ))}
            </div>
          </div>
        );
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-[1200px] mx-auto px-6 py-4">
          <nav className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-gray-900 font-medium">İstanbul Silivri Villa Pleksi Korkuluk Projesi</span>
          </nav>
        </div>
      </div>
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-4">
              <div className="relative overflow-hidden rounded-2xl">
                <img
                  ...
                  alt="Silivri villa pleksi korkuluk"
              ...
              <div className="grid grid-cols-5 gap-2">
                {images.map((src, i) => (
                  ...
                  >
                    <img src={src} alt={`Silivri pleksi korkuluk ${i + 1}`} className="w-full h-16 object-cover hover:scale-110 transition-transform duration-300" />
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <h1 className="text-4xl font-bold text-gray-900">İstanbul Silivri Villa Pleksi Korkuluk Projesi</h1>
              <div className="flex items-center space-x-6 text-gray-600">
                <div className="flex items-center space-x-2"><MapPin size={18} /><span>Silivri, İstanbul</span></div>
                <div className="flex items-center space-x-2"><Calendar size={18} /><span>2024</span></div>
              </div>
              <p className="text-lg text-gray-700 leading-relaxed">
                Villa iç merdivenlerinde kullanılan şeffaf pleksi korkuluk sistemi; modern görünüm, güvenlik ve dayanıklılığı bir arada sunar.
              </p>
      ...
      {isLightboxOpen && (
        ...
        >
          ...
          >
            <img
              src={images[selectedImage]}
              alt="Silivri villa pleksi korkuluk - büyük"
      ...
      <section className="py-16 bg-gradient-to-r from-[#b91c1c] to-[#991b1b] text-white">
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">Silivri'deki örnek projemiz gibi şeffaf pleksi korkuluk çözümleri için bizimle iletişime geçin.</p>
