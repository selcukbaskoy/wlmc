...
export default function PleksiglasKorkulukDikme3502Twisted100LukDiamond() {
  ...
  const images = [
    "https://walmco.com/urunler/pleksi%20diamond%20seri%20%C3%BCr%C3%BCnler/3502%20twisted%20100%20l%C3%BCk%20pleksi%20dikme.png",
  ];

  const handleQuoteRequest = () => {
    const productInfo = {
      name: "Pleksiglas Korkuluk Dikme – 3502 Twisted 100 Lük",
      category: "Pleksi Diamond Seri",
      description: "3502 Twisted 100 Lük model pleksiglas korkuluk dikme. Diamond seri özel tasarımı ile premium görünüm. Hızlı kargo, garanti.",
      image: "https://walmco.com/urunler/pleksi%20diamond%20seri%20%C3%BCr%C3%BCnler/3502%20twisted%20100%20l%C3%BCk%20pleksi%20dikme.png",

      specifications: {
        "Model": "3502 Twisted 100 Lük",
        "Boy": "1000 mm",
  ...
  const handleWhatsApp = () => {
    const message = `Merhaba, 3502 Twisted 100 Lük Diamond seri pleksiglas korkuluk dikme ürünü hakkında bilgi almak istiyorum.\n\nÜrün Detayları:\n- Model: 3502 Twisted 100 Lük\n- Boy: 1000 mm\n- Seri: Diamond Seri\n- Malzeme: Pleksiglas (PMMA)\n\n\nDetaylı bilgi ve teklif almak istiyorum.`;
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <nav className="text-sm text-gray-600 mb-6">
          <ol className="list-none p-0 inline-flex">
            ...
            <li className="text-gray-900">3502 Twisted 100 Lük</li>
          </ol>
        </nav>
            ...
            <div className="relative">
              <div className="overflow-hidden rounded-lg bg-gray-100">
                <img
                  ...
                  alt="3502 Twisted 100 Lük Diamond Seri Pleksiglas Korkuluk Dikme"
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">
                Pleksiglas Korkuluk Dikme – 3502 Twisted 100 Lük
              </h1>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-gray-600">4.9 (18 değerlendirme)</span>
              </div>
              <p className="text-gray-700 text-lg">
                3502 Twisted 100 Lük model pleksiglas korkuluk dikmesi. Diamond seri özel tasarımı ile premium görünüm sunan, 
                twisted (burkulu) detayı ile estetik çözüm.
              </p>
            </div>
            ...
            {activeTab === "ozellikler" && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-lg border">
                  <h3 className="font-semibold text-lg mb-3">Twisted (Burkulu) Tasarım</h3>
                  <p className="text-gray-600">Özel twisted (burkulu) detayı ile estetik ve fonksiyonel tasarım</p>
                </div>
                <div className="bg-white p-6 rounded-lg border">
                ...
                <div className="bg-white p-6 rounded-lg border">
                  <h3 className="font-semibold text-lg mb-3">100 Lüks Model</h3>
                  <p className="text-gray-600">100 lüks özel tasarım ile farklı projelerde kullanım imkanı</p>
                </div>
                <div className="bg-white p-6 rounded-lg border">
            ...
            {activeTab === "teknik" && (
              <div className="bg-white p-6 rounded-lg border">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <span className="font-medium">Model:</span> 3502 Twisted 100 Lük
                  </div>
                  <div>
                    <span className="font-medium">Boy:</span> 1000 mm
                  </div>
                  <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg border overflow-hidden hover:shadow-lg transition duration-200">
              <img
                   ...
                   productName="3502 diamond Model"
                   className="w-full h-48 object-cover"
              
                 />
              <div className="p-4">
                <h3 className="font-semibold text-lg mb-2">3500 Köşegen 100 Lük Şişe Dikme</h3>
